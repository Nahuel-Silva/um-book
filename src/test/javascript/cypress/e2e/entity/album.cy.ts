...
describe('Album e2e test', () => {
  ...
  describe('new Album page', () => {
    ...
    it('should create an instance of Album', () => {
      cy.get(`[data-cy="nombre"]`).type('Métricas Sopa transmit').should('have.value', 'Métricas Sopa transmit');

      cy.get(`[data-cy="descripcion"]`).type('en').should('have.value', 'en');

      cy.get(`[data-cy="cantFotos"]`).type('86697').should('have.value', '86697');
